...
describe('schema', function() {
  ...
  it('returns empty if no data', function() {
    const emptyEntities = {
      polls: {},
      options: {},
      votes: {},
    ...
    const poll = denormalize(13, emptyEntities, schema.poll)
    const polls = denormalize([11,12], emptyEntities, schema.arrayOfPolls)
    expect(polls).to.eql([{}, {}])
  })
})
