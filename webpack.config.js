...
const vendor = ['babel-polyfill', 'isomorphic-fetch', 'rxjs', 'react',
  'react-dom', 'react-toolbox', 'react-router',  'react-router-redux',
  'redux', 'react-redux', 'redux-observable', 'normalizr', 'denormalizr',
  'moment', 'jsonwebtoken', 'redbox-react', 'lodash.merge']
